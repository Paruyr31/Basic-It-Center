...
delay = {}
delay['name'] = ['surname']
b = requests.request("GET", "https://httpbin.org/anything")
print(b.content)
b1 = requests.request("DELETE", "https://httpbin.org/absolute-redirect")
print(b1.content)
b2 = requests.request("GET", "https://httpbin.org/image/jpeg")
print(b2.content)
b3 = requests.request("POST", "https://httpbin.org/delay", data=delay)
print(b3)
b4 = requests.request("PUT", "https://httpbin.org/delay", data=delay)


z = {}
z["name"] = ["surname"]
m = requests.request("GET", "https://github.com")
print(m.content)
m1 = requests.request("POST", "https://github.com/settings", data=z)
print(m1.content)
m2 = requests.request("DELETE", "https://github.com/account")
print(m2.content)
m3 = requests.request("PUT", "https://github.com/pulls", data=z)
print(m3.content)
